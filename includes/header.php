    ...
    <nav>
        <div class="nav-container">
            ...
            <ul class="nav-links" id="navLinks">
                <li><a href="index.php" <?php echo ($current === 'index.php') ? 'class="active"' : ''; ?>>Home</a></li>
                <li><a href="about.php" <?php echo ($current === 'about.php') ? 'class="active"' : ''; ?>>About</a></li>
                <li><a href="services.php" <?php echo ($current === 'services.php') ? 'class="active"' : ''; ?>>Services</a></li>
                <li><a href="portfolio.php" <?php echo ($current === 'portfolio.php') ? 'class="active"' : ''; ?>>Portfolio</a></li>
                <li><a href="gallery.php" <?php echo ($current === 'gallery.php') ? 'class="active"' : ''; ?>>Gallery</a></li>
